...
1. `tunedTweet.py` - Creates a tweet based on a tuned babbage engine. If this doesn't work, just replace the engine with a generic. See tk for details about how this was tuned. See [Fine tuning](doc/tuning.md) for details.
